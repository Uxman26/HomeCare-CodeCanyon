                            ...
                            <div class="package-field">
                                <div class="package-select">
                                    <select class="form-control" name="basic_revision" id="basic_revision">
                                        ...
                                        @endfor
                                        <option value="unlimited" @if($project_details->standard_revision == 'unlimited') selected @endif>{{ __('Unlimited') }}</option>
                                    </select>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="package-field">
                                <div class="package-select">
                                    <select class="form-control disabled_or_not" name="premium_revision" id="premium_revision">
                                        ...
                                        @endfor
                                        <option value="1000" @if($project_details->premium_revision == 'unlimited') selected @endif>{{ __('Unlimited') }}</option>
                                    </select>
                                </div>
                            </div>
                        </td>
